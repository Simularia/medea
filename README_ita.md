...
I parametri z (altezza a cui è riferita la velocità del vento) e stabclass (classe di stabilità, con lettere A,B,C,D,E,F oppure numeri 1,2,3,4,5,6) sono utilizzati soltanto per lo schema 1, i parametro ws e wd non sono utilizzati nello schema 3.
